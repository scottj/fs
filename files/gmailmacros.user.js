...
const HANDLERS_TABLE = {
  ...
  66: [MARK_AS_UNREAD], // B: mark as UnRead //~ V is used by view conversation
  84: [MOVE_TO_TRASH],// T: move to Trash
  68: [MARK_AS_READ, ARCHIVE], // D: Discard
  73: [MOVE_TO_INBOX] // I: Move to Inbox
};
...
const LABEL_ACTIONS = {
  ...
  71: function(labelName) {
    ...
    var eventType = labelName == "Contacts" ? "mousedown" : "mousedown";
...
const ADDED_KEYS_HELP = {
    ...
    "b" : "Mark as Unread a message or conversation",
    ...
    "z+<i>label</i>" : "Removes <i>label</i> from conversation(s)",
...
function beginLabelAction() {
  ...
  /* Added 5/12/2006 - Sewpafly
   * If the labels div is closed open and then close it again */
  if (divs.length == 3){
...
function getNodeSet() {
  ...
  taglineNode.innerHTML = 'GmailMacros';
